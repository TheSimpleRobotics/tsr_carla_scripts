...
Use ARROWS or WASD keys for control.
    ...
    CTRL cd+ +     : increments the start time of the replay by 1 second (+SHIFT = 10 seconds)
...
class World(object):
    def __init__(self, carla_world, actor_filter):
        ...
        self.semcam1_svs_front = None
        self.semcam2_svs_rigtht = None
        self.semcam3_svs_back = None
        self.semcam4_svs_rear = None      
    ...
    def restart(self):
        ...
        # Add semseg GT cameras
        self.semcam1_svs_front = self.camera_tsr.add_camera(x=0.8, y=0.0, z=1.7, 
                                                         roll=0, pitch=-15, yaw=0,
                                                         camera_type='sensor.camera.semantic_segmentation')

        self.semcam2_svs_right = self.camera_tsr.add_camera( x=0.0, y=0.5, z=1.7, 
                                                         roll=0, pitch=-15, yaw=90,
                                                         camera_type='sensor.camera.semantic_segmentation')

        self.semcam3_svs_back = self.camera_tsr.add_camera(x=-0.8, y=0.0, z=1.7, 
                                                         roll=0, pitch=-15, yaw=180,
                                                         camera_type='sensor.camera.semantic_segmentation')

        self.semcam4_svs_left = self.camera_tsr.add_camera( x=0.0, y=-0.5, z=1.7, 
                                                         roll=0, pitch=-15, yaw=270,
                                                         camera_type='sensor.camera.semantic_segmentation')
    ...
    def destroy(self):
        actors = [
            ...
            self.cam3_svs_back,
            self.cam4_svs_rear,
            self.semcam1_svs_front,
            self.semcam2_svs_rigtht,
            self.semcam3_svs_back,
            self.semcam4_svs_rear
            ]
        for actor in actors:
